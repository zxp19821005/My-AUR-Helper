...
const menuItems = [
  { path: "/settings", label: "通用设置", icon: Icon.settingsGeneral },           // 通用设置
  { path: "/settings/list", label: "列表设置", icon: Icon.settingsList },          // 列表设置
  { path: "/settings/aur", label: "AUR 设置", icon: Icon.settingsAur },            // AUR 设置
...
<template>
  ...
  <PopupLayout title="设置" :icon="Icon.navSettings" :menuItems="menuItems" />
</template>
