...
> 问题总数：22 项（高风险 1 项、中风险 10 项、低风险 11 项），已修复 22 项
...
| M-002 | ✅ 已修复 | 2026-07-29 | 拆分压缩的 CSS 属性为多行格式（该文件已于 2026-07-30 删除） |
...
| L-008 | ✅ 已修复 | 2026-08-20 | 将 `rowDelete` 重命名为 `rowDeleteSelected`，与 `deleteSelected` 命名模式一致 |
| L-009 | ✅ 已修复 | 2026-07-29 | 提取 row_to_software_info 辅助函数 |
| L-010 | ✅ 已修复 | 2026-08-20 | 提取 `build_result` 辅助函数，消除 4 处重复 CheckResult 构造 |
